...
DEFERRED_TOOL_SEARCH_GUIDE = (
    ...
    "call `search_tools` once, then call the loaded tool directly. Before "
    "concluding data or a capability is unavailable, `search_tools` the domain "
    "(git, filesystem roots, command/code execution, databases) — deferred "
    "tools often expose the environment you need."
)
