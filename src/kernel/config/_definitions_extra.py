...
EXTRA_SETTING_DEFINITIONS: dict[str, dict] = {
    ...
    "CHECKPOINT_MONGO_POOL_MIN_SIZE": {
        ...
        "category": SettingCategory.CHECKPOINT,
        "subcategory": "mongodb",
        "description": "settingDesc.CHECKPOINT_MONGO_POOL_MIN_SIZE",
        "default": 2,
        "depends_on": {"key": "CHECKPOINT_BACKEND", "value": "mongodb"},
        "frontend_visible": True,
    },
    "CHECKPOINT_MONGO_POOL_MAX_SIZE": {
        ...
        "category": SettingCategory.CHECKPOINT,
        "subcategory": "mongodb",
        "description": "settingDesc.CHECKPOINT_MONGO_POOL_MAX_SIZE",
        "default": 10,
        "depends_on": {"key": "CHECKPOINT_BACKEND", "value": "mongodb"},
        "frontend_visible": True,
    },
