...
export function buildSubcategoryLabels(t: Translate): Record<string, string> {
  return {
    ...
    langfuse: t("subcategories.langfuse"),
    mongodb: t("subcategories.mongodb"),
    performance: t("subcategories.performance"),
    query_context: t("subcategories.query_context"),
    recommendations: t("subcategories.recommendations"),
    self_evolve: t("subcategories.self_evolve"),
    skills: t("subcategories.skills"),
    task: t("subcategories.task"),
    vector: t("subcategories.vector"),
    vfs: t("subcategories.vfs"),
    web_fetch: t("subcategories.web_fetch"),
    web_push: t("subcategories.web_push"),
    web_search: t("subcategories.web_search"),
